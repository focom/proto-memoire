...
def createQuery(name):
    ...
    //Level 2
    (Ceasy:Chapitre {name:"Contenus dapprentissage",grade:0,id_node:6,score:0,weight:0,history:0}), (Chard:Chapitre {name:"Contenus dappronfondissement",grade:0,id_node:7,score:0,weight:0,history:0}),
    (Tphrase:Chapitre {name:"Type de phrase",grade:0,id_node:8,score:0,weight:0,history:0}), (conjugaison:Chapitre {name:"Contenus pour laccord du verbe",grade:0,score:0,weight:0,id_node:9,history:0}),
    (omonyme:Chapitre {name:"Homonyme",grade:0,id_node:10,score:0,weight:0,history:0}),(autre:Chapitre {name:"Autre Cas",grade:0,id_node:11,score:0,weight:0,history:0}),
    ...
    (:Exercice {id_node:16,instruction:"Trouve le sujet", question:"Au souper, mon pere le réprimandera", answer:["pere","souper"], correct:"pere"})-[:link]->(Ceasy),
    (:Exercice {id_node:17,instruction:"Trouve le complement de la phrase", question:"La petite sexcusera à la prochaine visite", answer:["à la prochaine visite","La petite"], correct:"à la prochaine visite"})-[:link]->(Ceasy),
    ...
    (:Exercice {id_node:22,instruction:"Trouve le verbe", question:"Morgane trouve un mouton rouge dans le champ", answer:["trouve","dans"], correct:"mange"})-[:link]->(Ceasy),
    ...
    // Exercice 2
    (:Exercice {id_node:25,instruction:"Trouve le sujet", question:"Les mathematiques sont une matierre difficile", answer:["mathemathique","Matiere"], correct:"mathematique"})-[:link]->(Chard),
    ...
    (:Exercice {id_node:30,instruction:"Trouve le complement de la phrase", question:"La prochaine fois, ma classe participera a un concours", answer:["la prochaine fois","un concours"], correct:"la prochaine fois"})-[:link]->(Chard),
    ...
    // Exercice 3
    (:Exercice {id_node:38,instruction:"Identifie le type de phrase", question:"Avez vous vus Pierre ce matin ?", answer:["interogatif","declaratif"], correct:"interogatif"})-[:link]->(Tphrase),
    (:Exercice {id_node:39,instruction:"Identifie le type de phrase", question:"Repondez-moi.", answer:["imperatif","exclamatif"], correct:"imperatif"})-[:link]->(Tphrase),
    (:Exercice {id_node:40,instruction:"Identifie le type de phrase", question:"Comme il avait lair triste !", answer:["exclamatif","declaratif"], correct:"declaratif"})-[:link]->(Tphrase),
    (:Exercice {id_node:41,instruction:"Identifie le type de phrase", question:"Il a perdu mon beau gilet de laine.", answer:["declaratif","exclamatif"], correct:"declaratif"})-[:link]->(Tphrase),
    (:Exercice {id_node:42,instruction:"Identifie le type de phrase", question:"Vite, allez le chercher", answer:["imperatif","exclamatif"], correct:"imperatif"})-[:link]->(Tphrase),
    ...
    //Exercice 4
    (:Exercice {id_node:51,instruction:"choisis la bonne orthographe", question:"Michel et et moi (aller) au cinéma", answer:["allons","allon"], correct:"allons"})-[:link]->(conjugaison),
    (:Exercice {id_node:52,instruction:"choisis la bonne orthographe", question:"Michel et toi (aller) au cinéma", answer:["allez","alles"], correct:"allez"})-[:link]->(conjugaison),
    (:Exercice {id_node:53,instruction:"choisis la bonne orthographe", question:"Christine et lui (aller) au cinéma", answer:["vont","vons"], correct:"vont"})-[:link]->(conjugaison),
    (:Exercice {id_node:54,instruction:"choisis la bonne orthographe", question:"Le chat et la souris (danser)", answer:["dansent","danses"], correct:"dansent"})-[:link]->(conjugaison),
    (:Exercice {id_node:55,instruction:"choisis la bonne orthographe", question:"Je leur (pardonner) ces erreurs", answer:["pardonne","pardonnent"], correct:"pardonne"})-[:link]->(conjugaison),
    (:Exercice {id_node:56,instruction:"choisis la bonne orthographe", question:"Je (etre) votre collaborateur", answer:["suis","est"], correct:"suis"})-[:link]->(conjugaison),
    (:Exercice {id_node:57,instruction:"choisis la bonne orthographe", question:"Une foule de gens (bloquer) la rue", answer:["bloque","bloquent"], correct:"bloque"})-[:link]->(conjugaison),
    (:Exercice {id_node:58,instruction:"choisis la bonne orthographe", question:"Les chiffres, les lettres, tout (etre) du chinois", answer:["est","fus"], correct:"est"})-[:link]->(conjugaison),
    (:Exercice {id_node:59,instruction:"choisis la bonne orthographe", question:"Dans le ravin (couler) un ruisselet", answer:["coule","coulet"], correct:"coule"})-[:link]->(conjugaison),
    (:Exercice {id_node:60,instruction:"choisis la bonne orthographe", question:"il (arriver) des touristes de partout", answer:["arrive","arrivent"], correct:"arrive"})-[:link]->(conjugaison),
    (:Exercice {id_node:61,instruction:"choisis la bonne orthographe", question:"Mon ami Martine et moi (rire) souvent pour rien", answer:["rions","riont"], correct:"rions"})-[:link]->(conjugaison),
    ...
    //Exercice 5
    (:Exercice {id_node:63,instruction:"choisis la bonne orthographe", question:"les enfants _ couchent tôt", answer:["se","ce"], correct:"se"})-[:link]->(omonyme),
    (:Exercice {id_node:64,instruction:"choisis la bonne orthographe", question:"Sait-tu _ que tu veux?", answer:["se","ce"], correct:"se"})-[:link]->(omonyme),
    ...
    (:Exercice {id_node:66,instruction:"choisis la bonne orthographe", question:"Léa _ prend pour une autre femme.", answer:["se","ce"], correct:"se"})-[:link]->(omonyme),
    ...
    (:Exercice {id_node:68,instruction:"choisis la bonne orthographe", question:"Aime tu la vanille _ le chocolat", answer:["ou","où"], correct:"ou"})-[:link]->(omonyme),
